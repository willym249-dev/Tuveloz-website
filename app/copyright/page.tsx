...
export const metadata: Metadata = {
  ...
  description:
    "How to report content on Tuveloz that infringes a copyright, what a valid notice must include, how to counter-notice, and what happens to repeat infringers.",
  alternates: {
    canonical: "/copyright",
  },
};
