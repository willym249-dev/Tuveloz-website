...
const spanishText: Record<string, string> = {
  ...
  "Tuveloz is building a local marketplace where you can post a car need once, compare providers and prices side by side, and choose. Customer accounts are open now; requests turn on once the right provider coverage is in place.": "Tuveloz está creando un mercado local donde podrá publicar una necesidad de su carro una vez, comparar proveedores y precios lado a lado, y elegir. Las cuentas de clientes ya están abiertas; las solicitudes se activarán cuando exista la cobertura adecuada de proveedores.",
