...
const spanishText: Record<string, string> = {
  ...
  "SMS terms": "Términos de mensajes de texto",
  ...
  "Tuveloz confirms only the specific license, registration, or insurance the law requires for a given service. It does not run criminal background checks on providers or their personnel, and being listed on Tuveloz is not a character endorsement. If a screening step is ever added for a specific service, Tuveloz will describe exactly what is checked and nothing more.": "Tuveloz confirma únicamente la licencia, el registro o el seguro específico que la ley exige para un servicio determinado. No realiza verificaciones de antecedentes penales a los proveedores ni a su personal, y aparecer en Tuveloz no es un respaldo de su carácter. Si alguna vez se agrega un paso de verificación para un servicio específico, Tuveloz describirá exactamente qué se revisa y nada más.",
