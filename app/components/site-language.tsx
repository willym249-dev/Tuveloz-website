...
const spanishText: Record<string, string> = {
  ...
  "One simple sign-in. The right tools only.": "Un inicio de sesión sencillo. Solo las herramientas correctas.",
  "Enter the email used for your customer request or verified provider account. We'll email a one-time code—no password needed.": "Ingrese el correo usado para su solicitud de cliente o su cuenta de proveedor verificado. Le enviaremos un código de un solo uso; no necesita contraseña.",
  "Customer": "Cliente",
  ...
  "Provider sign-in is available only after Tuveloz approves and verifies your account.": "El inicio de sesión para proveedores está disponible solo después de que Tuveloz apruebe y verifique su cuenta.",
  ...
  "Codes expire after 10 minutes and work once. Tuveloz never asks for your email password.": "Los códigos vencen después de 10 minutos y funcionan una sola vez. Tuveloz nunca pide la contraseña de su correo.",
