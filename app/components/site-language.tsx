...
const spanishText: Record<string, string> = {
  ...
  "DMV vehicle-service marketplace": "Mercado de servicios para vehículos del DMV",
  "Operating now in Montgomery County, Maryland": "Operando ahora en el Condado de Montgomery, Maryland",
  "Outside the county? Request your DMV area →": "¿Está fuera del condado? Solicite su área del DMV →",
  ...
  "Future DMV expansion": "Expansión futura en el DMV",
  "Bring Tuveloz to your DMV area.": "Lleve Tuveloz a su área del DMV.",
  "Tuveloz currently operates only in Montgomery County, Maryland. Customers and providers elsewhere in DC, Maryland, or Virginia can request their area. We'll use combined demand to choose where to launch next.": "Tuveloz opera actualmente solo en el Condado de Montgomery, Maryland. Los clientes y proveedores de otras áreas de DC, Maryland o Virginia pueden solicitar su área. Usaremos la demanda combinada para decidir dónde lanzar próximamente.",
  "Customers": "Clientes",
  ...
  "We'll compare customer and provider demand as Tuveloz plans its next DMV launch area.": "Compararemos la demanda de clientes y proveedores mientras Tuveloz planifica su próxima área de lanzamiento en el DMV.",
  ...
  "Enter your county or independent city and choose a DMV state or district.": "Ingrese su condado o ciudad independiente y elija un estado o distrito del DMV.",
  ...
  "Enter a Montgomery County ZIP code, or request your DMV area for future expansion.": "Ingrese un código postal del Condado de Montgomery o solicite su área del DMV para una futura expansión.",
  ...
  "DMV marketplace · Operating now in Montgomery County, Maryland.": "Mercado del DMV · Operando ahora en el Condado de Montgomery, Maryland.",
