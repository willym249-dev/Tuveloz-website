...
export const spanishText: Record<string, string> = {
  "We're building a way for Montgomery County car owners to find independent vehicle-service providers. Customers choose who to work with, and providers set their own prices and hours.": "Estamos creando una forma de que los dueños de vehículos del Condado de Montgomery encuentren proveedores independientes. Los clientes eligen con quién trabajar y los proveedores fijan sus propios precios y horarios.",
  ...
  "We're building Tuveloz to help neighbors in Montgomery County find local vehicle services, compare quotes, and ask questions before choosing someone. You can create a free account today. Customer bookings are not open yet.": "Estamos creando Tuveloz para que los vecinos de Montgomery County encuentren servicios locales para su vehículo, comparen cotizaciones y hagan preguntas antes de elegir. Ya puede crear una cuenta gratis. Las reservas para clientes aún no están abiertas.",
  ...
  "Choosing someone to work on your car is a big decision. You deserve to understand the work, the price, and who will be doing it.": "Elegir a alguien para trabajar en su carro es una decisión importante. Usted merece entender el trabajo, el precio y quién lo hará.",
