...
export const spanishText: Record<string, string> = {
  ...
  "We're building Tuveloz to help neighbors in Montgomery County find local vehicle services, compare quotes, and ask questions before choosing an independent service provider. You can create a free account today. Customer bookings are not open yet.": "Estamos creando Tuveloz para que los vecinos del Condado de Montgomery encuentren servicios locales para su vehículo, comparen cotizaciones y hagan preguntas antes de elegir un proveedor independiente. Ya puede crear una cuenta gratis. Las reservas para clientes aún no están abiertas.",
