...
export const spanishText: Record<string, string> = {
  ...
  "Sponsored trainee employee": "Empleado aprendiz con empresa patrocinadora",
  "Provider business employee": "Empleado de una empresa proveedora",
  "Sponsored trainee": "Aprendiz con empresa patrocinadora",
  "Provisional independent": "Proveedor independiente provisional",
  "Standard provider": "Proveedor estándar",
  "Specialty provider": "Proveedor especializado",

  "Automated verification is blocked for manual review. No service or job access was granted.": "La verificación automática está bloqueada y requiere revisión manual. No se concedió acceso a servicios ni a trabajos.",
  "Independent startup": "Empresa independiente",
  "Photo documentation only": "Solo documentación fotográfica",
  "Accepted Service-Specific Provisional Competency Evidence": "Evidencia aceptada de competencia provisional para el servicio específico",
  "Independent Startup No-Employee Attestation": "Declaración de empresa independiente sin empleados",
  "Workers' Compensation Coverage Evidence": "Constancia de cobertura de compensación laboral",
  "Approved Sponsored-Provider Personnel Roster": "Lista de personal aprobada de la empresa proveedora patrocinadora",
  "Sponsored Provider Employment and Lawful-Pay Attestation": "Declaración de empleo y pago legal de la empresa proveedora patrocinadora",
  "Eligible Supervisor Assignment for the Exact Service": "Asignación de un supervisor habilitado para el servicio específico",
  "Provisional visual observation report": "Informe provisional de observación visual",
  "Provisional OBD-II read-only service": "Servicio provisional de lectura OBD-II",
  "Montgomery County Motor Vehicle Repair/Maintenance/Towing Certificate": "Certificado del condado de Montgomery para reparación, mantenimiento o remolque de vehículos",
  "Provisional wiper-blade replacement": "Reemplazo provisional de escobillas del limpiaparabrisas",
  "Provisional engine or cabin air-filter replacement": "Reemplazo provisional del filtro de aire del motor o de la cabina",
  "Provisional conventional-bulb replacement": "Reemplazo provisional de bombillas convencionales",
  "Provisional limited fluid top-off": "Reposición limitada y provisional de líquidos",
  "Provisional 12-volt jump start": "Arranque provisional con cables para baterías de 12 voltios",
  "Provisional 12-volt battery replacement": "Reemplazo provisional de baterías de 12 voltios",
  "Approved Spent-Battery Handling and Recycler Plan": "Plan aprobado de manejo y reciclaje de baterías usadas",
  "Provisional temporary-spare installation": "Instalación provisional de una llanta de repuesto temporal",
  "Provisional basic detailing": "Limpieza detallada básica provisional",
  "Approved Wash-Water Capture and Disposal Plan": "Plan aprobado de recolección y disposición del agua de lavado",
  "Sponsored oil and filter service": "Cambio de aceite y filtro con empresa patrocinadora",
  "Approved Used-Oil Capture, Storage, and Recycling Plan": "Plan aprobado de recolección, almacenamiento y reciclaje del aceite usado",
  "Registered Provider Current Personnel Roster": "Lista de personal vigente de la empresa proveedora registrada",
  "Registered Provider Employee and Lawful-Pay Record": "Registro de empleo y pago legal de la empresa proveedora registrada",
  "Tire repair or installation": "Reparación o instalación de llantas",
  "Mobile car wash": "Lavado de autos a domicilio",
  "Motor-vehicle air-conditioning service": "Servicio de aire acondicionado de vehículos",
  "EPA Section 609 Technician Certificate": "Certificado de técnico conforme a la sección 609 de la EPA",
  "Body and paint refinishing": "Reparación de carrocería y acabado de pintura",
  "Applicable Maryland Vehicle-Refinishing Air Permit/Coverage": "Permiso o cobertura ambiental aplicable en Maryland para emisiones del acabado de vehículos",
  "Window-tint installation": "Instalación de polarizado de ventanas",
  "Approved Window-Tint Compliance and Meter Controls": "Controles aprobados de cumplimiento y medición del polarizado de ventanas",
  "Towing or storage": "Remolque o almacenamiento de vehículos",
  "Montgomery County Towing Registration": "Registro de remolque del condado de Montgomery",
  "Applicable Tow-Vehicle Registration": "Registro aplicable del vehículo de remolque",
  "Commercial or Business-Use Auto Coverage": "Cobertura de automóvil comercial o de uso empresarial",
  "Broker-Approved On-Hook, Custody, and Garagekeepers Coverage": "Cobertura aprobada por el corredor para vehículos en remolque, custodia y bajo el cuidado del taller",
  "Vehicle lockout": "Apertura de vehículos cerrados",
  "Maryland Locksmith Business License": "Licencia de empresa de cerrajería de Maryland",
  "Applicable Locksmith Technician/Employee Registration Evidence": "Documentación de registro aplicable al técnico o empleado de cerrajería",
  "Certificate of General Liability Insurance": "Certificado de seguro de responsabilidad civil general",
  "Official vehicle inspection": "Inspección oficial de vehículos",
  "Maryland Licensed Inspection Station Evidence": "Constancia de estación de inspección autorizada en Maryland",
  "Maryland Licensed Inspection Mechanic Evidence": "Constancia de mecánico de inspección autorizado en Maryland",
  "Emergency fuel delivery": "Entrega de combustible de emergencia",
  "Applicable Maryland Motor-Fuel Registration": "Registro de combustible para vehículos aplicable en Maryland",
  "Approved Fuel Vehicle, Container, Hazmat, Spill, Environmental, and Fire Package": "Documentación aprobada del vehículo de combustible, recipientes, materiales peligrosos, derrames, protección ambiental y contra incendios",
  "EV high-voltage service": "Servicio de alto voltaje para vehículos eléctricos",
  "Approved EV High-Voltage Training, PPE, Tools, Facility, and Emergency Package": "Documentación aprobada de capacitación en alto voltaje de vehículos eléctricos, equipo de protección personal, herramientas, instalaciones y respuesta a emergencias",
  ...
  "Requires input": "Se necesita información",
  "Processing": "En proceso",
  "Closed": "Cerrado",
  "Blocked": "Bloqueado",
  "Manual review required": "Se requiere revisión manual",
  "New": "Nueva",
  ...
  "Needs correction": "Se necesita una corrección",
  "Review required": "Se requiere revisión",
  "Pending review": "Revisión pendiente",
  "Inactive": "Inactivo",
  "Your Stripe identity and adult-status verification is current.": "Su verificación de identidad y mayoría de edad con Stripe está vigente.",
  "Your external manual identity and adult-status verification is current.": "Su verificación externa manual de identidad y mayoría de edad está vigente.",
  "Every business, credential, insurance, exact-service, agreement, and launch requirement still applies.": "Siguen aplicándose todos los requisitos de empresa, credenciales, seguro, servicio específico, acuerdos y lanzamiento.",

  "Under review — still blocked": "En revisión; el servicio sigue bloqueado",
  "Correction needed": "Se necesita una corrección",
  "Not accepted — correction or appeal available": "No aceptado; puede corregirlo o apelar",
  "Expired — replacement required": "Vencido; se necesita un reemplazo",
  "Unable to load provider onboarding.": "No pudimos cargar los pasos de su solicitud.",
  "Automatic identity-status refresh ended. Use Refresh status below if Stripe is still processing.": "Terminó la actualización automática de identidad. Use Actualizar estado si Stripe aún está procesando su verificación.",
  "Unable to refresh identity status.": "No pudimos actualizar el estado de identidad.",
  "Unable to start identity verification.": "No pudimos iniciar la verificación de identidad.",
  "Stripe returned an unexpected verification address. No redirect was opened.": "Stripe devolvió una dirección de verificación inesperada. No se abrió ningún enlace.",
  "Identity status refreshed. Job access remains controlled by every other launch gate.": "Se actualizó el estado de identidad. El acceso a trabajos sigue sujeto a los demás requisitos de lanzamiento.",
  "TUVELOZ reviews evidence for each exact service. An upload, account approval, or status badge is not a promise of safety, quality, or outcome and does not waive TUVELOZ's own legal duties.": "TUVELOZ revisa los documentos de cada servicio específico. Subir un documento, aprobar una cuenta o mostrar un estado no garantiza la seguridad, la calidad ni los resultados, ni exime a TUVELOZ de sus propias obligaciones legales.",
  "TUVELOZ does not employ or train anybody.": "TUVELOZ no contrata ni capacita a nadie.",
  "Applying, uploading a document, completing onboarding, or receiving a review result does not create employment, training, a job offer, wages, placement, customer jobs, or any promise of future work.": "Presentar una solicitud, subir un documento, completar los pasos de registro o recibir un resultado de revisión no crea una relación laboral, capacitación, oferta de empleo, salario, colocación, trabajos con clientes ni promesa de trabajo futuro.",
  "Loading your onboarding checklist…": "Cargando los pasos de su solicitud…",
  "Policy v": "Política v",
  "Not recorded": "Sin registrar",
  "Evidence review": "Revisión de documentos",
  "✓ means a listed requirement was accepted. ✕ means the service cannot be used for a customer job. ⏳ means TUVELOZ received an item, but job access remains blocked.": "✓ indica que se aceptó un requisito de la lista. ✕ indica que el servicio no está disponible para trabajos con clientes. ⏳ indica que TUVELOZ recibió un documento, pero el acceso a trabajos sigue bloqueado.",
  "Independent owner-operator only": "Solo para propietarios que trabajan por cuenta propia",
  "Identity and adult-status verification": "Verificación de identidad y mayoría de edad",
  "Status:": "Estado:",
  "No Stripe Identity attempt has started.": "No se ha iniciado ningún intento de verificación con Stripe Identity.",
  "Automated Stripe Identity is not available for an employee or trainee pathway. TUVELOZ does not employ or train providers. A separate person-level invitation, consent, and employer/provider-of-record workflow is required before that person can be reviewed.": "La verificación automática con Stripe Identity no está disponible para empleados ni aprendices. TUVELOZ no contrata ni capacita a proveedores. Antes de revisar a esa persona, se necesita una invitación individual, su consentimiento y el proceso correspondiente con su empleador o empresa proveedora responsable.",
  "This older application does not contain the required immutable performing-person name. Do not start Stripe Identity. Contact TUVELOZ for assisted re-attestation or the external manual identity-and-age review.": "Esta solicitud anterior no contiene el registro inalterable requerido del nombre de la persona que realizará el trabajo. No inicie Stripe Identity. Contacte a TUVELOZ para actualizar esa declaración con ayuda o solicitar una revisión externa manual de identidad y edad.",
  "An existing external identity record cannot be replaced automatically. No new ID or selfie will be collected until TUVELOZ completes owner review.": "No se puede reemplazar automáticamente un registro externo de identidad existente. No se recopilará una nueva identificación ni selfie hasta que la persona responsable de TUVELOZ complete la revisión.",
  "Automated verification is blocked for manual review": "La verificación automática está bloqueada y requiere revisión manual",
  ". No service or job access was granted.": ". No se concedió acceso a servicios ni a trabajos.",
  "The prior verification is no longer current. Contact TUVELOZ for a reviewed manual alternative or complete a new verification below. Service and job access remains blocked until current verification and every other gate pass again.": "La verificación anterior ya no está vigente. Contacte a TUVELOZ para una alternativa manual revisada o complete una nueva verificación abajo. El acceso a servicios y trabajos sigue bloqueado hasta que la verificación esté vigente y se cumplan todos los demás requisitos.",
  "External manual": "Manual externa",
  "identity and adult-status verification is current. Every business, credential, insurance, exact-service, agreement, and launch gate still applies.": "La verificación de identidad y mayoría de edad está vigente. Siguen aplicándose todos los requisitos de empresa, credenciales, seguro, servicio específico, acuerdos y lanzamiento.",
  "Stripe captures a government-issued ID and a selfie and performs a biometric face comparison. TUVELOZ processes Stripe's result and limited verified output; this Identity flow persists only non-sensitive references, status/decision, dates, consent certification, and an account-session digest; not ID images, ID numbers, a new copy of your name, or date of birth. Stripe retains data under its own policy. Read the": "Stripe captura una identificación oficial y una selfie, y realiza una comparación biométrica del rostro. TUVELOZ procesa el resultado de Stripe y una cantidad limitada de información verificada. Este proceso guarda únicamente referencias no sensibles, el estado o la decisión, fechas, la certificación del consentimiento y un resumen criptográfico de la sesión de la cuenta; no guarda imágenes ni números de identificación, una nueva copia de su nombre ni su fecha de nacimiento. Stripe conserva los datos según su propia política. Lea la",
  "TUVELOZ Privacy Policy": "Política de privacidad de TUVELOZ",
  "Stripe Privacy Policy": "Política de privacidad de Stripe",
  "Stripe Identity support": "Ayuda de Stripe Identity",
  "For a manual/non-biometric alternative, email": "Para una alternativa manual sin biometría, escriba a",
  ". The alternative may take longer, and service/job access stays blocked while it is reviewed.": ". Esta alternativa puede tardar más. El acceso a servicios y trabajos sigue bloqueado durante la revisión.",
  "Opening Stripe...": "Abriendo Stripe…",
  "Resume securely with Stripe": "Continuar de forma segura con Stripe",
  "Verify securely with Stripe": "Verificar de forma segura con Stripe",
  "Stripe Identity is not configured in the correct test/live mode for this provider.": "Stripe Identity no está configurado en el modo de prueba o real que corresponde a este proveedor.",
  "Refresh status": "Actualizar estado",
  "No exact services are on this application.": "Esta solicitud no tiene servicios específicos seleccionados.",
  "Submitted": "Enviado",
  "Malware scan:": "Análisis de seguridad:",
  "Review note:": "Nota de revisión:",
  "Download my clean private submission": "Descargar mi documento privado revisado por el análisis de seguridad",
  "This file is quarantined and cannot be opened or downloaded unless its malware scan reports clean. It cannot satisfy a requirement while blocked.": "Este archivo está en cuarentena. No se puede abrir ni descargar hasta que el análisis de seguridad confirme que está libre de amenazas. Mientras esté bloqueado, no puede cumplir un requisito.",
  "Appeal": "Apelación",
  "· submitted": "· enviada",
  "Response:": "Respuesta:",
  "This item is created by the employer, supervisor, or TUVELOZ review workflow; it cannot be satisfied by uploading personal work-authorization records.": "Este requisito se registra mediante el proceso del empleador, supervisor o equipo de revisión de TUVELOZ; no se puede cumplir subiendo documentos personales de autorización de trabajo.",
  "This applicant-only selection has no upload checklist and provides no training or customer jobs. Choose a provider pathway only when your independent business or genuine employment relationship with a separate provider business is ready for review.": "Esta opción de cuenta de solicitante no tiene una lista de documentos para subir y no ofrece capacitación ni trabajos con clientes. Elija una modalidad de proveedor cuando su empresa independiente o su relación laboral real con otra empresa proveedora esté lista para revisión.",
  "Renewal controls": "Renovaciones",
  "Expiration and reminders": "Vencimientos y recordatorios",
  "Renewal reminders do not extend eligibility. A replacement remains blocked until its malware scan is clean and TUVELOZ separately accepts the evidence.": "Los recordatorios de renovación no extienden la elegibilidad. El documento de reemplazo sigue bloqueado hasta que su análisis de seguridad esté libre de amenazas y TUVELOZ lo acepte por separado.",
  "No submitted evidence with an expiration date is currently tracked.": "Actualmente no hay documentos enviados con fecha de vencimiento registrada.",
  "Corrections and appeals": "Correcciones y apelaciones",
  "Decision status": "Estado de las decisiones",
  "Upload a corrected replacement from the affected checklist item, or submit an appeal when a review is marked “Needs correction” or “Rejected.” An appeal is not approval, is not a background-report dispute process, and never restores access while a gate is unmet.": "Suba un reemplazo corregido desde el requisito afectado o presente una apelación cuando la revisión indique «Se necesita una corrección» o «Rechazado». Una apelación no es una aprobación ni un proceso para disputar un informe de antecedentes. Tampoco restablece el acceso mientras falte algún requisito.",
  "No evidence appeals have been submitted.": "No se han presentado apelaciones de documentos.",
  "Target response by": "Fecha prevista de respuesta:",
  "Restricted documents": "Documentos de acceso restringido",
  "Privacy, retention, and deletion": "Privacidad, conservación y eliminación",
  "A legal hold currently limits deletion; eligible data remains under review.": "Una obligación de conservación legal limita actualmente la eliminación; los datos que pueden eliminarse siguen en revisión.",
  "Easy provider guide": "Guía para proveedores",
  "Seven steps": "Siete pasos",
  "Never upload an SSN, Social Security card, passport, I-9, or other work-authorization document here. The employer keeps those records and uses the separate employer attestation workflow.": "No suba aquí un SSN, tarjeta del Seguro Social, pasaporte, formulario I-9 ni otro documento de autorización de trabajo. El empleador conserva esos registros y utiliza el proceso separado de declaración del empleador.",
  "Application-review record": "Registro de revisión de la solicitud",
  "Policy acknowledgments": "Confirmaciones de las políticas",
  "Acknowledging a draft lets TUVELOZ review the application. It does not make the document active, approve any service, or allow customer jobs. If a policy is later released for job eligibility, the provider must affirmatively accept that released version.": "Confirmar un borrador permite que TUVELOZ revise la solicitud. No activa el documento, aprueba servicios ni habilita trabajos con clientes. Si después se publica una política que permite cumplir los requisitos para trabajar, el proveedor debe aceptar expresamente esa versión publicada.",
  "· release status": "· estado de publicación",
  "Application-review acknowledgment required": "Se requiere confirmar la lectura para revisar la solicitud",
  "Active released agreement accepted for job eligibility": "Acuerdo vigente publicado y aceptado para la elegibilidad de trabajos",
  "Not current for job eligibility": "No vigente para la elegibilidad de trabajos",
  "Authorized signer name": "Nombre de la persona autorizada para firmar",
  "Signer title or capacity": "Cargo o función de quien firma",
  "Acknowledge displayed versions": "Confirmar las versiones mostradas",
  "No expiration date is recorded": "No hay una fecha de vencimiento registrada",
  "Clean — private download allowed": "Sin amenazas; se permite la descarga privada",
  "Pending — quarantined and blocked": "Pendiente; en cuarentena y bloqueado",
  "Scanning — quarantined and blocked": "Analizando; en cuarentena y bloqueado",
  "Threat detected — blocked": "Amenaza detectada; bloqueado",
  "Scan failed — blocked pending a new clean result": "El análisis falló; bloqueado hasta obtener un nuevo resultado sin amenazas",
  "Scan error — blocked pending a new clean result": "Error de análisis; bloqueado hasta obtener un nuevo resultado sin amenazas",
  "No clean scan result — quarantined and blocked": "Sin resultado libre de amenazas; en cuarentena y bloqueado",
  "No expiration reminder is needed": "No se necesita un recordatorio de vencimiento",
  "No expiration reminder is currently scheduled": "Actualmente no hay un recordatorio de vencimiento programado",
  "✕ Applicant only — no training, employment, or customer jobs": "✕ Solo solicitante; sin capacitación, empleo ni trabajos con clientes",
  "✕ Not available for customer jobs": "✕ No disponible para trabajos con clientes",
  "Every service remains blocked until all evidence is accepted and TUVELOZ records satisfaction of mandatory legal, government, insurance, tax, payment, security, and exact-service requirements.": "Todos los servicios siguen bloqueados hasta que se acepten los documentos y TUVELOZ registre el cumplimiento de los requisitos legales, gubernamentales, de seguros, impuestos, pagos, seguridad y de cada servicio específico.",
  "Provider applications and evidence review are open. Current policy acknowledgments are application-review records only while any document is draft, inactive, not yet effective, or missing its released-content hash. They cannot qualify a provider for jobs. Real customer jobs, checkout, completion, and payout remain disabled.": "Se aceptan solicitudes de proveedores y documentos para revisión. Las confirmaciones actuales solo sirven para revisar la solicitud mientras algún documento sea un borrador, esté inactivo, aún no entre en vigor o no tenga su huella de contenido publicado. No habilitan a un proveedor para trabajos. Los trabajos reales con clientes, el cobro, la finalización y los pagos a proveedores siguen deshabilitados.",
  "Applicant-only account": "Cuenta solo para solicitantes",
  "Provider documents are stored in restricted private storage. Every new file is quarantined and unavailable for download or evidence acceptance until a malware scan reports clean.": "Los documentos de proveedores se guardan en almacenamiento privado de acceso restringido. Cada archivo nuevo queda en cuarentena y no se puede descargar ni aceptar hasta que el análisis de seguridad confirme que está libre de amenazas.",
  "Only the signed-in provider and specifically authorized TUVELOZ reviewers may access a clean private document. Access is logged. Documents and internal review notes never appear on a public provider page.": "Solo el proveedor que haya iniciado sesión y el personal de revisión de TUVELOZ expresamente autorizado pueden acceder a un documento privado libre de amenazas. El acceso queda registrado. Los documentos y las notas internas de revisión nunca aparecen en un perfil público de proveedor.",
  "TUVELOZ keeps provider documents only while needed for application review, current compliance, security and fraud prevention, disputes, or legal obligations. Replaced and rejected documents remain restricted audit records only while one of those purposes continues; they do not create job eligibility.": "TUVELOZ conserva los documentos de proveedores solo mientras sean necesarios para revisar la solicitud, comprobar el cumplimiento vigente, mantener la seguridad, prevenir el fraude, resolver disputas o cumplir obligaciones legales. Los documentos reemplazados y rechazados siguen siendo registros de auditoría restringidos únicamente mientras continúe uno de esos fines; no habilitan trabajos.",
  "You may request access, correction, portability, or deletion below. TUVELOZ verifies identity before acting and deletes or de-identifies eligible data when it is no longer required. A limited audit record may remain when required for security, fraud prevention, a dispute, law, or an active legal hold.": "Puede solicitar acceso, corrección, portabilidad o eliminación abajo. TUVELOZ verifica su identidad antes de actuar y elimina o desidentifica los datos que ya no deben conservarse. Puede mantenerse un registro de auditoría limitado cuando lo exijan la seguridad, la prevención del fraude, una disputa, la ley o una obligación de conservación legal activa.",
  "Do not upload an SSN, Social Security card, passport, I-9, bank record, tax ID, or work-authorization document. A separate employer or payment-processor workflow must keep those records.": "No suba un SSN, tarjeta del Seguro Social, pasaporte, formulario I-9, registro bancario, identificación fiscal ni documento de autorización de trabajo. Esos registros deben conservarse mediante un proceso separado del empleador o del procesador de pagos.",
  "Choose the pathway that matches the real working relationship.": "Elija la modalidad que corresponda a su relación de trabajo real.",
  "Choose exact services; a broad general-mechanic category is never accepted.": "Elija servicios específicos; no se acepta una categoría general de mecánica.",
  "Upload only the evidence requested for each exact service. Every file stays quarantined until its malware scan reports clean.": "Suba solo los documentos solicitados para cada servicio específico. Cada archivo queda en cuarentena hasta que el análisis de seguridad confirme que está libre de amenazas.",
  "TUVELOZ reviews each clean item; an upload or appeal alone does not create eligibility.": "TUVELOZ revisa cada documento libre de amenazas; subirlo o presentar una apelación no basta para habilitar trabajos.",
  "Accept every current provider agreement with the authorized signer name and title.": "Acepte todos los acuerdos vigentes para proveedores con el nombre y cargo de la persona autorizada para firmar.",
  "A checkmark appears only after the exact service, person, location, date, evidence, and supervision rules pass.": "La marca de verificación aparece solo cuando se cumplen las reglas del servicio específico, la persona, el lugar, la fecha, los documentos y la supervisión.",
  "Keep evidence current and follow the displayed reminder schedule. Expiration before a scheduled job blocks that job.": "Mantenga los documentos vigentes y siga el calendario de recordatorios. Si vencen antes de un trabajo programado, ese trabajo queda bloqueado.",
  "Sign in with the provider email used on your application.": "Inicie sesión con el correo de proveedor que usó en su solicitud.",
  "This update must come from TUVELOZ.": "Esta actualización debe enviarse desde TUVELOZ.",
  "Sign in with your provider account.": "Inicie sesión con su cuenta de proveedor.",
  "Choose the reviewed evidence and explain the appeal in at least 20 characters.": "Elija el documento revisado y explique la apelación con al menos 20 caracteres.",
  "Evidence review not found.": "No se encontró la revisión del documento.",
  "An appeal is available only after evidence receives a correction or rejection decision.": "Solo puede apelar después de recibir una decisión de corrección o rechazo del documento.",
  "An appeal for this evidence is already pending.": "Ya hay una apelación pendiente para este documento.",
  "Choose a privacy request, add details, and acknowledge identity verification and lawful retention limits.": "Elija un tipo de solicitud de privacidad, añada detalles y confirme que entiende la verificación de identidad y los límites legales de conservación.",
  "Choose a supported onboarding action.": "Elija una acción válida para su solicitud.",
  "The displayed policies have changed. Refresh the page and review them again before accepting.": "Las políticas mostradas han cambiado. Actualice la página y vuelva a revisarlas antes de aceptarlas.",
  "Enter the authorized signer and complete both required acceptance controls.": "Indique quién tiene autorización para firmar y complete las dos confirmaciones obligatorias.",
  "Unable to save this onboarding update.": "No pudimos guardar esta actualización de su solicitud.",
  "Identity verification needs manual review. No service or job access was granted.": "La verificación de identidad necesita revisión manual. No se concedió acceso a servicios ni a trabajos.",
  "The Stripe Identity session binding or mode could not be verified. No URL was released.": "No pudimos verificar la vinculación o el modo de la sesión de Stripe Identity. No se proporcionó ningún enlace.",
  "Unable to cancel a superseded hosted identity session.": "No se pudo cancelar una sesión anterior de verificación de identidad.",
  "The daily identity-attempt limit was reached. Try again tomorrow or contact TUVELOZ for manual review.": "Alcanzó el límite diario de intentos de verificación. Inténtelo mañana o contacte a TUVELOZ para una revisión manual.",
  "Wait one minute before another identity attempt.": "Espere un minuto antes de intentar verificar su identidad de nuevo.",
  "Identity-verification attempt could not be claimed.": "No se pudo reservar el intento de verificación de identidad.",
  "Stripe Identity is configured in the wrong mode for this provider. No URL was released.": "Stripe Identity está configurado en el modo incorrecto para este proveedor. No se proporcionó ningún enlace.",
  "The new Stripe Identity session binding could not be verified. No URL was released.": "No pudimos verificar la vinculación de la nueva sesión de Stripe Identity. No se proporcionó ningún enlace.",
  "This request must come from TUVELOZ.": "Esta solicitud debe enviarse desde TUVELOZ.",
  "Sign in with the provider account used to apply.": "Inicie sesión con la cuenta de proveedor que usó para presentar la solicitud.",
  "The identity consent has changed. Refresh the page and review it again before continuing.": "El consentimiento de identidad ha cambiado. Actualice la página y vuelva a revisarlo antes de continuar.",
  "Consent to Stripe's government-ID, selfie, biometric-comparison, adult-status, and same-person checks is required.": "Debe dar su consentimiento a las verificaciones de identificación oficial, selfie, comparación biométrica, mayoría de edad y coincidencia de la persona con Stripe.",
  "Automated Stripe Identity is limited to a signed-in independent owner-operator verifying themself. Employee and trainee identity requires a separate person-level invitation and consent flow.": "Stripe Identity automático está limitado a propietarios independientes que hayan iniciado sesión y estén verificando su propia identidad. Los empleados y aprendices necesitan una invitación individual y un proceso de consentimiento separado.",
  "The provider-person application binding is incomplete.": "La vinculación entre la solicitud y la persona proveedora está incompleta.",
  "Identity verification is unavailable until the current owner-operator roster and independent-business binding are corrected.": "La verificación de identidad no está disponible hasta que se corrijan el registro actual de la persona propietaria y su vinculación con la empresa independiente.",
  "This older application does not contain an immutable performing-person name. Use TUVELOZ's assisted re-attestation/manual review before automated Stripe Identity.": "Esta solicitud anterior no contiene un registro inalterable del nombre de la persona que realizará el trabajo. Solicite ayuda a TUVELOZ para actualizar la declaración o realizar una revisión manual antes de usar Stripe Identity automático.",
  "The existing external identity record is current, partial, mixed, malformed, or not from an approved configured provider. TUVELOZ owner review is required before any new ID or selfie is collected.": "El registro externo de identidad existente está vigente, es parcial, mezcla fuentes, tiene errores o proviene de un proveedor no configurado y aprobado. La persona responsable de TUVELOZ debe revisarlo antes de recopilar una nueva identificación o selfie.",
  "Confirm that the expired external verification may be replaced before continuing to Stripe.": "Confirme que autoriza reemplazar la verificación externa vencida antes de continuar con Stripe.",
  "A test provider requires Stripe Identity test mode. The expired external record was not changed.": "Un proveedor de prueba requiere el modo de prueba de Stripe Identity. No se modificó el registro externo vencido.",
  "Real provider identity verification requires a live restricted Stripe Identity key. The expired external record was not changed.": "La verificación de identidad de proveedores reales requiere una clave restringida de Stripe Identity en modo real. No se modificó el registro externo vencido.",
  "The external verification changed while this request was being reviewed. No new ID or selfie was collected; refresh and try again.": "La verificación externa cambió mientras se revisaba esta solicitud. No se recopiló una nueva identificación ni selfie; actualice la página e inténtelo de nuevo.",
  "A test provider requires Stripe Identity test mode.": "Un proveedor de prueba requiere el modo de prueba de Stripe Identity.",
  "Real provider identity verification requires a live restricted Stripe Identity key.": "La verificación de identidad de proveedores reales requiere una clave restringida de Stripe Identity en modo real.",
  "The existing Stripe identity record does not exactly match a guarded approval for the current application. No new ID or selfie was collected; TUVELOZ owner review is required.": "El registro de Stripe Identity existente no coincide exactamente con una aprobación validada de la solicitud actual. No se recopiló una nueva identificación ni selfie; la persona responsable de TUVELOZ debe revisarlo.",
  "Unable to start Stripe Identity verification.": "No pudimos iniciar la verificación con Stripe Identity.",

  "Request type": "Tipo de solicitud",
  "Choose one": "Elija una opción",
  "Submitting…": "Enviando…",
  "Explain what should be reconsidered": "Explique qué decisión desea que revisemos",
  "Identify the decision, explain why you believe it should change, and note any supporting information.": "Indique la decisión, explique por qué considera que debe cambiar e incluya la información que la respalda.",
  "Submit appeal": "Enviar apelación",
  "An appeal does not approve evidence or restore job access. The affected service remains blocked while the appeal is pending.": "Enviar una apelación no aprueba el documento ni habilita trabajos. El servicio afectado sigue sin estar disponible mientras se revisa la apelación.",
  "Submit privacy request": "Enviar solicitud de privacidad",
  "Access my provider data": "Consultar mis datos de proveedor",
  "Correct my provider data": "Corregir mis datos de proveedor",
  "Receive a portable copy": "Recibir una copia de mis datos en un formato reutilizable",
  "Delete eligible provider data": "Eliminar los datos de proveedor que se puedan borrar",
  "I understand TUVELOZ may verify my identity and that deletion can exclude records that must be retained for security, fraud prevention, legal obligations, disputes, or an active legal hold.": "Entiendo que Tuveloz puede verificar mi identidad y que algunos registros deben conservarse por seguridad, prevención de fraude, obligaciones legales, disputas o una orden de conservación vigente.",
  "Appeal submitted. It will be reviewed by someone other than the original reviewer where practical; the service remains blocked meanwhile.": "Apelación enviada. Cuando sea posible, la revisará una persona distinta de quien tomó la decisión original. El servicio sigue sin estar disponible mientras tanto.",
  "Privacy request submitted. TUVELOZ will verify scope, apply any lawful retention or legal-hold limits, and record the response here.": "Solicitud de privacidad enviada. Tuveloz revisará su alcance, aplicará los límites legales de conservación que correspondan y registrará la respuesta aquí.",
  "Provider application": "Solicitud de proveedor",
  "Your next steps": "Sus próximos pasos",
  "Choose a service below to see which documents to send and what still needs review.": "Elija un servicio a continuación para ver qué documentos debe enviar y qué queda por revisar.",
  "How your application is reviewed": "Cómo revisamos su solicitud",
  "Your application": "Su solicitud",
  "Your checklist": "Su lista de requisitos",
  "Documents for your services": "Documentos para sus servicios",
  "We review your documents separately from your ID check. Only the requirements for your selected services appear here.": "Revisamos sus documentos por separado de la verificación de identidad. Aquí solo aparecen los requisitos de los servicios que eligió.",
  "Stripe could not complete your ID check. Resume the check to see what needs to be corrected.": "Stripe no pudo completar la verificación de su identidad. Reanude la verificación para ver qué necesita corregir.",
  "Your request was received. Refresh the page to see its status.": "Recibimos su solicitud. Actualice la página para ver su estado.",
  "Appeal submitted for review.": "Apelación enviada para revisión.",
  "Privacy request submitted.": "Solicitud de privacidad enviada.",
  "Current agreement versions accepted and recorded.": "Versiones actuales de los acuerdos aceptadas y registradas.",
  "Unable to submit this appeal.": "No pudimos confirmar que se recibió su apelación. Inténtelo de nuevo.",
  "Unable to submit this privacy request.": "No pudimos confirmar que se recibió su solicitud de privacidad. Inténtelo de nuevo.",
  ...
  "Ask about fees, parts, or applying as a provider. Our automated guide uses Tuveloz's policies to answer your questions. If you need more help, you can contact the owner below.": "Pregunte sobre tarifas, piezas o cómo registrarse como proveedor. Nuestra guía automatizada usa las políticas de Tuveloz para responder sus preguntas. Si necesita más ayuda, puede contactar al dueño más abajo.",
  "More details:": "Más detalles:",
  "Tuveloz AI does not diagnose or inspect your vehicle, give a price quote, guarantee pricing, dispatch help, or choose a provider. Read the linked policies for details. Need more help? Email": "Tuveloz AI no diagnostica ni inspecciona su vehículo, no ofrece cotizaciones ni garantiza precios, y tampoco envía ayuda ni elige un proveedor. Consulte los enlaces a las políticas para más detalles. ¿Necesita más ayuda? Escriba a",
  "Customer bookings and payments are not open yet.": "Las reservas y los pagos de clientes aún no están disponibles.",
  ". Customer bookings and payments are not open yet.": ". Las reservas y los pagos de clientes aún no están disponibles.",
  "More time for your work": "Más tiempo para su trabajo",
  "Keep the paperwork in one place.": "Reúna los documentos en un solo lugar.",
  "We're building one place for appointments, quotes, job photos, and invoices, so you can spend more time on your work.": "Estamos reuniendo citas, cotizaciones, fotos de trabajos y facturas en un solo lugar para que pueda dedicar más tiempo a su trabajo.",
  "You can apply and explore now. Tools for managing customer jobs become available when bookings open. You stay in charge of your prices, hours, and work.": "Puede enviar su solicitud y explorar ahora. Las herramientas para gestionar trabajos de clientes estarán disponibles cuando se abran las reservas. Usted sigue a cargo de sus precios, horarios y trabajo.",
  "Choose any that would help your business.": "Elija las que le servirían en su negocio.",
  "A 5% Customer Service Fee is calculated from the provider's price and added to your total. You see the provider's price, the fee, and the total before you accept anything.": "La Tarifa de Servicio al Cliente del 5% se calcula sobre el precio del proveedor y se suma a su total. Usted ve el precio del proveedor, la tarifa y el total antes de aceptar.",
  "English and Spanish support": "Ayuda en inglés y español",
  "Review the quote, work authorization and invoice in English or Spanish with your customer.": "Revise con su cliente la cotización, la autorización de trabajo y la factura en inglés o español.",
  "Agree on parts before the visit": "Acuerden las piezas antes de la visita",
  "Review the needed parts with your customer before agreeing to the work. Customers purchase parts separately.": "Revise con su cliente las piezas necesarias antes de acordar el trabajo. Los clientes compran las piezas por separado.",
  "Tools for work on the go": "Herramientas para trabajar donde esté",
  "Keep appointments, job notes and photos together while you're working at a customer's location or in your shop.": "Reúna citas, notas y fotos del trabajo mientras trabaja donde está el cliente o en su taller.",
  "Tools to keep each job organized.": "Herramientas para organizar cada trabajo.",
  "We're building tools to manage quotes, appointments and job records in one place, while you stay in charge of your business.": "Estamos creando herramientas para gestionar cotizaciones, citas y registros de trabajo en un solo lugar, mientras usted sigue al frente de su negocio.",
  "These tools will be available for real jobs after the required launch reviews. You can apply now and complete your service checklist before customer bookings open.": "Estas herramientas estarán disponibles para trabajos reales después de las revisiones necesarias para el lanzamiento. Puede solicitar ahora y completar la lista de sus servicios antes de que se abran las reservas para clientes.",
  "Tell us about your business.": "Cuéntenos sobre su negocio.",
  "An online marketplace for local vehicle services.": "Un mercado en línea de servicios locales para vehículos.",
  "Answers about Tuveloz, fees, provider applications and the upcoming customer launch in Montgomery County, Maryland.": "Respuestas sobre Tuveloz, cargos, solicitudes de proveedores y el próximo lanzamiento para clientes en Montgomery County, Maryland.",
  "Get to know Tuveloz.": "Conozca Tuveloz.",
  "Learn how joining works, who does the work and what to expect. Provider applications are open; customer bookings are not open yet.": "Vea cómo unirse, quién realiza el trabajo y qué puede esperar. Las solicitudes de proveedores están abiertas; las reservas para clientes aún no están disponibles.",
  "Who will work on my vehicle?": "¿Quién trabajará en mi vehículo?",
  "Tuveloz is an online marketplace connecting customers with independent vehicle-service businesses. The provider you choose does the work. Tuveloz does not meet customers or repair vehicles. This does not change Tuveloz's own responsibilities under applicable law.": "Tuveloz es un mercado en línea que conecta a clientes con negocios independientes de servicios para vehículos. El proveedor que usted elige realiza el trabajo. Tuveloz no se reúne con clientes ni repara vehículos. Esto no cambia las responsabilidades de Tuveloz conforme a la ley aplicable.",
  "Do providers work for Tuveloz?": "¿Los proveedores trabajan para Tuveloz?",
  "Providers run their own businesses and are responsible for their employees, training, supervision, insurance and job assignments. Tuveloz does not employ, train, sponsor, assign or supervise providers or their staff. An applicant account does not include training or jobs.": "Los proveedores dirigen sus propios negocios y son responsables de sus empleados, capacitación, supervisión, seguros y asignación de trabajos. Tuveloz no emplea, capacita, patrocina, asigna ni supervisa a proveedores ni a su personal. Una cuenta de solicitante no incluye capacitación ni trabajos.",
  "What will it cost to use Tuveloz?": "¿Cuánto costará usar Tuveloz?",
  "Creating an account and applying as a provider are free. Customer requests and payments are not open yet. The planned booking fee is explained below; final launch pricing and tax treatment remain under review. You'll see every charge and the refund terms before paying.": "Crear una cuenta y solicitar como proveedor es gratis. Las solicitudes y los pagos de clientes aún no están disponibles. El cargo previsto para las reservas se explica abajo; los precios finales y el tratamiento de impuestos siguen en revisión. Verá todos los cargos y las condiciones de reembolso antes de pagar.",
  "Each provider sets their own price and decides which requests to answer. You can compare the quotes you receive before choosing. Quotes will become available when customer bookings open.": "Cada proveedor fija su precio y decide qué solicitudes responder. Puede comparar las cotizaciones que reciba antes de elegir. Las cotizaciones estarán disponibles cuando se abran las reservas para clientes.",
  "What checks does a provider need?": "¿Qué revisiones necesita un proveedor?",
  "Requirements depend on the service and where the work happens. Insurance, registration, a license or other documents may be needed. Tuveloz checks what is required for the work a provider applies to offer. Approval for one service does not cover every service.": "Los requisitos dependen del servicio y de dónde se realiza el trabajo. Puede necesitarse seguro, registro, licencia u otros documentos. Tuveloz revisa lo necesario para el trabajo que un proveedor solicita ofrecer. La aprobación de un servicio no cubre todos los servicios.",
  "We're starting in Montgomery County, Maryland. Provider applications are open there; customer bookings and payments are not open yet. You can request another area on our About page.": "Empezamos en Montgomery County, Maryland. Allí están abiertas las solicitudes de proveedores; las reservas y los pagos de clientes aún no están disponibles. Puede solicitar otra zona en nuestra página Acerca de Tuveloz.",
  "How do I continue my application?": "¿Cómo continúo mi solicitud?",
  "Sign in with the email you used to apply and choose your provider account. Your checklist shows which documents to add and what still needs review. You'll be able to see the status of your application there.": "Inicie sesión con el correo que usó para solicitar y elija su cuenta de proveedor. Su lista muestra qué documentos agregar y qué falta revisar. Allí podrá ver el estado de su solicitud.",
  "See how Tuveloz will connect you with local providers, help you compare quotes and let you choose. Customer bookings are not open yet.": "Vea cómo Tuveloz le conectará con proveedores locales para comparar cotizaciones y elegir. Las reservas para clientes aún no están abiertas.",
  "Find help for your car, one step at a time.": "Encuentre ayuda para su carro, paso a paso.",
  "Provider applications are open in Montgomery County. Customer requests, quotes and payments are not open yet. Here's how booking will work when we launch.": "Las solicitudes de proveedores están abiertas en Montgomery County. Las solicitudes, cotizaciones y pagos de clientes aún no están disponibles. Así funcionarán las reservas cuando abramos.",
  "1. Tell us what you need": "1. Cuéntenos qué necesita",
  "Describe your vehicle, what you've noticed and when you'd like help. Choose where the work could happen and how you'll get any needed parts. You don't need to diagnose the problem yourself.": "Describa su vehículo, lo que ha notado y cuándo necesita ayuda. Elija dónde podría realizarse el trabajo y cómo conseguirá las piezas necesarias. No necesita diagnosticar el problema por su cuenta.",
  "2. Hear from local providers": "2. Reciba respuestas de proveedores locales",
  "Your request goes to providers who cover your area and are approved for that service. Each business decides whether to send a quote and sets its own price. Your private contact details stay with the provider you select.": "Su solicitud llega a proveedores que cubren su zona y están aprobados para ese servicio. Cada negocio decide si envía una cotización y fija su propio precio. Sus datos privados de contacto se comparten con el proveedor que seleccione.",
  "3. Compare and choose": "3. Compare y elija",
  "Review the work, price and timing in each quote. Ask questions before deciding. You can turn down every quote at no cost. Checks and documents help you make a choice; they do not guarantee safety, quality or results.": "Revise el trabajo, el precio y el tiempo de cada cotización. Haga preguntas antes de decidir. Puede rechazar todas las cotizaciones sin costo. Las revisiones y los documentos le ayudan a elegir; no garantizan seguridad, calidad ni resultados.",
  "4. Agree on the work and appointment": "4. Acuerde el trabajo y la cita",
  "Before accepting, you'll see the business and person doing the work, all charges and the refund terms. Confirm the appointment with your provider. Any extra work needs your approval, and the provider must remain cleared through payment.": "Antes de aceptar, verá el negocio y la persona que harán el trabajo, todos los cargos y las condiciones de reembolso. Confirme la cita con su proveedor. Todo trabajo adicional necesita su aprobación, y el proveedor debe seguir autorizado hasta el pago.",
  "Who does the work?": "¿Quién realiza el trabajo?",
  "Your selected provider business performs the service. Tuveloz connects you online; it does not meet customers or work on vehicles. Tuveloz does not employ, train, sponsor, assign or supervise providers or their staff. Each provider business handles its own hiring, payroll, training and supervision.": "El negocio proveedor que usted elige realiza el servicio. Tuveloz le conecta en línea; no se reúne con clientes ni trabaja en vehículos. Tuveloz no emplea, capacita, patrocina, asigna ni supervisa a proveedores ni a su personal. Cada negocio proveedor gestiona su contratación, nómina, capacitación y supervisión.",
  "Learn what Tuveloz checks for each service, how your information is shared and what you will see before accepting a quote.": "Conozca qué revisa Tuveloz para cada servicio, cómo se comparte su información y qué verá antes de aceptar una cotización.",
  "Know who's working on your car.": "Sepa quién trabajará en su carro.",
  "Here's what Tuveloz checks, what providers can see and how you'll review a quote. Provider applications are open; customer bookings are not open yet.": "Vea qué revisa Tuveloz, qué información pueden ver los proveedores y cómo revisará una cotización. Las solicitudes de proveedores están abiertas; las reservas para clientes aún no están disponibles.",
  "Checks for the work you need": "Revisiones para el trabajo que necesita",
  "Before a job can go ahead, Tuveloz checks the service, the person doing the work, the location and date, current documents and agreements, and any required supervision. Each label says what was checked. These checks do not guarantee safety, quality or results.": "Antes de que un trabajo pueda realizarse, Tuveloz revisa el servicio, la persona que lo hará, el lugar y la fecha, los documentos y acuerdos vigentes y la supervisión necesaria. Cada etiqueta indica qué se revisó. Estas revisiones no garantizan seguridad, calidad ni resultados.",
  "Checks for the specific service": "Revisiones para el servicio específico",
  "Checks for the person and location": "Revisiones de la persona y el lugar",
  "Expired documents block access to jobs": "Los documentos vencidos impiden el acceso a trabajos",
  "Tuveloz checks the license, registration or insurance required for a particular service. It does not run criminal background checks on providers or their staff. A listing is not a character endorsement. If a screening step is added, we will explain what it covers.": "Tuveloz revisa la licencia, el registro o el seguro requerido para un servicio específico. No realiza verificaciones de antecedentes penales de proveedores ni de su personal. Aparecer en el directorio no es un aval de conducta. Si se agrega una revisión, explicaremos qué abarca.",
  "See the full price before you agree": "Vea el precio total antes de aceptar",
  "When bookings open, you'll see the provider's labor price, the separate Customer Service Fee, taxes or other charges, refund terms and the total before confirming. You buy any needed parts separately; parts are not paid for through Tuveloz.": "Cuando se abran las reservas, verá el precio de la mano de obra del proveedor, el Cargo por Servicio al Cliente separado, los impuestos u otros cargos, las condiciones de reembolso y el total antes de confirmar. Usted compra las piezas necesarias por separado; las piezas no se pagan mediante Tuveloz.",
  "You choose your provider": "Usted elige a su proveedor",
  "You decide which provider to hire. Providers choose their jobs, prices, schedule, tools and methods within the law and the work you agree to. Tuveloz does not employ, train, assign or supervise providers or their staff.": "Usted decide qué proveedor contratar. Los proveedores eligen sus trabajos, precios, horarios, herramientas y métodos conforme a la ley y al trabajo acordado. Tuveloz no emplea, capacita, asigna ni supervisa a proveedores ni a su personal.",
  "Create an account →": "Crear una cuenta →",
  "Read founding provider details →": "Leer los detalles del programa de proveedores fundadores →",
  "We're preparing these services for Montgomery County. Each will open when the right providers and required reviews are in place.": "Estamos preparando estos servicios para Montgomery County. Cada uno se abrirá cuando contemos con proveedores y se completen las revisiones necesarias.",
  "Need help with your car today?": "¿Necesita ayuda con su carro hoy?",
  "For service now, contact a local repair shop, mobile mechanic, or towing service directly. If you're unsure whether your car is safe to drive, have it checked before continuing your trip.": "Si necesita servicio ahora, contacte directamente a un taller local, un mecánico móvil o un servicio de remolque. Si no está seguro de que pueda conducir su carro sin peligro, haga que lo revisen antes de continuar su viaje.",
  "Get launch updates →": "Recibir novedades del lanzamiento →",
  "Have a dent, scuff, or paint job in mind? These services are still being considered. Tell us what you need so we can understand what matters to local car owners.": "¿Tiene una abolladura, un rayón o un trabajo de pintura pendiente? Aún estamos considerando estos servicios. Cuéntenos qué necesita para que entendamos qué les importa a los dueños de vehículos de la zona.",
  "Create a free account and add your vehicle details when you are ready. You can take your time getting familiar with Tuveloz before bookings open. Nothing on this page submits a request, contacts a provider, books service, or processes a payment.": "Cree una cuenta gratis y añada los datos de su vehículo cuando esté listo. Puede conocer Tuveloz a su propio ritmo antes de que se abran las reservas. Esta página no envía solicitudes, contacta proveedores, reserva servicios ni procesa pagos.",
  "Car care should feel less stressful.": "Cuidar su carro debería ser menos estresante.",
  "Local help. A choice you feel good about.": "Ayuda local. Una elección que le dé confianza.",
  "We're building Tuveloz so Montgomery County car owners can compare local providers, their work, and their prices in one place. Create your free account today. Customer requests open after launch.": "Estamos creando Tuveloz para que los dueños de carros del Condado de Montgomery puedan comparar proveedores locales, su trabajo y sus precios en un solo lugar. Cree su cuenta gratis hoy. Las solicitudes de clientes se abrirán después del lanzamiento.",
  "Your skills belong here.": "Aquí hay lugar para sus habilidades.",
  "Bring your car-care business to Tuveloz.": "Traiga su negocio de servicios para vehículos a Tuveloz.",
  "You know your work, your customers, and what your time is worth. We'd like to help you reach more local car owners when Tuveloz opens. Apply free, set your own prices and hours, and keep working with your own customers.": "Usted conoce su trabajo, a sus clientes y el valor de su tiempo. Queremos ayudarle a llegar a más dueños de vehículos de la zona cuando abra Tuveloz. Solicite gratis, fije sus precios y horarios, y siga atendiendo a sus propios clientes.",
  "What you can expect": "Qué puede esperar",
  "Your application, at your pace.": "Su solicitud, a su ritmo.",
  "Choose the work you offer, see what's needed, and finish when you're ready. You don't need your documents in hand to get started.": "Elija el trabajo que ofrece, revise lo que necesita y termine cuando esté listo. No necesita tener sus documentos a mano para empezar.",
  "Start with your services": "Empiece por sus servicios",
  "Select only the work you'd like to offer. We'll show you the next steps for those choices, so you can decide whether Tuveloz fits your business.": "Seleccione solo el trabajo que desea ofrecer. Le mostraremos los siguientes pasos para esas opciones, para que decida si Tuveloz encaja con su negocio.",
  "Add documents when you're ready": "Agregue sus documentos cuando esté listo",
  "Your checklist explains what we'll need for review. Start the application now, then add your documents through your private dashboard.": "Su lista explica lo que necesitaremos para la revisión. Empiece la solicitud ahora y después agregue sus documentos desde su panel privado.",
  "Tuveloz | Vehicle Services in Montgomery County, MD": "Tuveloz | Servicios para vehículos en Montgomery County, MD",
  "Feel informed before you decide.": "Decida con la información que necesita.",
  "Choosing a service provider for your car is a big decision. You deserve to understand the work, the price, and the business you'll be hiring.": "Elegir un proveedor de servicios para su carro es una decisión importante. Usted merece entender el trabajo, el precio y el negocio que contratará.",
  "What providers can expect": "Lo que pueden esperar los proveedores",
  "What customers can compare": "Lo que pueden comparar los clientes",
  "A simpler application": "Una solicitud más sencilla",
  "Before you choose": "Antes de elegir",
  "Apply for the work you already do.": "Solicite ofrecer el trabajo que ya realiza.",
  "See the details that matter.": "Vea los detalles que importan.",
  "The provider": "El proveedor",
  "Business details and approved services": "Datos del negocio y servicios aprobados",
  "The work": "El trabajo",
  "What the provider plans to do and what it costs": "Lo que el proveedor planea hacer y cuánto cuesta",
  "Hire one provider or decline every quote": "Contrate a un proveedor o rechace todas las cotizaciones",
  "Your services": "Sus servicios",
  "Choose only the work you want to offer": "Elija solo el trabajo que desea ofrecer",
  "See what each selected service requires": "Vea lo que requiere cada servicio seleccionado",
  "Your progress": "Su progreso",
  "Save your application and finish later": "Guarde su solicitud y termínela después",
  "Provider applications are open. Applying is free.": "Las solicitudes para proveedores están abiertas. Solicitar es gratis.",
  "Customer requests and quotes are open.": "Las solicitudes y cotizaciones de clientes están abiertas.",
  "Customer requests and quotes are not open yet.": "Las solicitudes y cotizaciones de clientes aún no están abiertas.",
  "A connection to local help": "Una conexión con ayuda local",
  "When bookings open, Tuveloz will help you compare local providers and keep the agreed work and price in one place. The provider you choose will do the work.": "Cuando se abran las reservas, Tuveloz le ayudará a comparar proveedores locales y reunir el trabajo y precio acordados. El proveedor que usted elija realizará el servicio.",
  "Providers set their own prices and hours. They work independently of Tuveloz, and you choose whose services fit your needs.": "Los proveedores fijan sus propios precios y horarios. Trabajan de forma independiente de Tuveloz, y usted elige los servicios que le convienen.",
  "Here to help you get started": "Aquí para ayudarle a empezar",
  "Have a question? You're welcome to ask.": "¿Tiene alguna pregunta? Con gusto le ayudamos.",
  "Our automated guide answers questions about Tuveloz, fees, and provider applications in English and Spanish using our published policies. If you still need help, send your question to the owner from the same page.": "Nuestra guía automatizada responde preguntas sobre Tuveloz, tarifas y solicitudes de proveedores en inglés y español, con base en nuestras políticas publicadas. Si necesita más ayuda, puede enviar su pregunta al dueño desde la misma página.",
  "Get answers": "Encontrar respuestas",
  "For our neighbors and local pros": "Para nuestros vecinos y profesionales locales",
  "Good car care starts with good connections.": "Un buen servicio empieza por encontrar a la persona adecuada.",
  "When Tuveloz opens, you'll be able to describe what your car needs, compare the quotes you receive, and ask questions before deciding. You don't need to know the technical terms to get started.": "Cuando abra Tuveloz, podrá describir lo que necesita su carro, comparar las cotizaciones que reciba y hacer preguntas antes de decidir. No necesita conocer los términos técnicos para empezar.",
  "Compare the quotes you receive": "Compare las cotizaciones que reciba",
  "Do you work on cars, offer detailing, or run a mobile service or shop? We'd like to hear from you. Choose the services you offer and we'll show you what's needed to apply. You can save your application and finish it later.": "¿Trabaja en carros, ofrece detallado o tiene un servicio móvil o taller? Nos gustaría conocerle. Elija los servicios que ofrece y le mostraremos qué necesita para solicitar. Puede guardar su solicitud y terminarla después.",
  "Services planned for launch": "Servicios previstos para el lanzamiento",
  "Help with the little things that keep you going.": "Ayuda con esos detalles que le permiten seguir adelante.",
  "We're preparing these services for Montgomery County. Each will open when the right providers and required reviews are in place. You can sign up for launch updates below.": "Estamos preparando estos servicios para Montgomery County. Cada uno se abrirá cuando contemos con proveedores y se completen las revisiones necesarias. Puede suscribirse abajo para recibir novedades del lanzamiento.",
  "Here is how we plan to connect you with local help. Customer requests are not open yet, but you can create your account now.": "Así planeamos conectarle con ayuda local. Las solicitudes de clientes aún no están abiertas, pero ya puede crear su cuenta.",
  "See the request. Send your quote. Let the customer decide.": "Revise la solicitud. Envíe su cotización. El cliente decide.",
  "Create your account at your own pace.": "Cree su cuenta a su propio ritmo.",
  "Your account is a good place to start.": "Su cuenta es un buen punto de partida.",
  "Create your account before launch": "Cree su cuenta antes del lanzamiento",
  "We'd like to meet the person behind the work.": "Nos gustaría conocer a la persona detrás del trabajo.",
  "Let's make car care a little easier.": "Hagamos que cuidar su carro sea un poco más fácil.",
  "Creating an account and applying as a provider are free. Customer bookings are not open yet. Have a question before joining? Email hello@tuveloz.com.": "Crear una cuenta y solicitar como proveedor es gratis. Las reservas para clientes aún no están abiertas. ¿Tiene alguna pregunta antes de unirse? Escriba a hello@tuveloz.com.",
  "Start my application": "Empezar mi solicitud",
  "A place for your business": "Un lugar para su negocio",
  "You've put time and care into learning your trade. Tuveloz is being built to help you offer that work locally, with your own prices and schedule. Applications are open while we prepare for customer bookings.": "Ha dedicado tiempo y esfuerzo a aprender su oficio. Estamos creando Tuveloz para ayudarle a ofrecer ese trabajo en su zona, con sus propios precios y horarios. Las solicitudes están abiertas mientras preparamos las reservas para clientes.",
  "Keep working your way": "Siga trabajando a su manera",
  "Keep your own customers and use other platforms too. You decide how Tuveloz fits into your business.": "Conserve sus propios clientes y use otras plataformas también. Usted decide cómo encaja Tuveloz en su negocio.",
  "Find requests near you": "Encuentre solicitudes cercanas",
  "After launch, your dashboard will show local requests for services you are cleared to offer. You choose which ones to quote.": "Tras el lanzamiento, su panel mostrará solicitudes locales de los servicios que tenga autorizados. Usted elige para cuáles enviar cotizaciones.",
  "Quotes you can reuse": "Cotizaciones que puede reutilizar",
  "Keep the agreed work, authorization, invoice, and receipt together. Customer payments will become available after launch review.": "Reúna el trabajo acordado, la autorización, la factura y el recibo. Los pagos de clientes estarán disponibles tras la revisión de lanzamiento.",
  "Review your completed jobs and business activity in your account, away from your public profile.": "Revise sus trabajos completados y la actividad de su negocio en su cuenta, fuera de su perfil público.",
  "The planned payment flow keeps payment records with the job. Payouts depend on completion evidence and the payment policy, including any holds or adjustments.": "El proceso de pago previsto reúne los registros de pago con el trabajo. Los desembolsos dependen de las pruebas de finalización y la política de pagos, incluidas las retenciones o ajustes aplicables.",
  "After launch, customers can review completed Tuveloz jobs. Those reviews will help others learn about your work.": "Tras el lanzamiento, los clientes podrán opinar sobre trabajos completados en Tuveloz. Esas reseñas ayudarán a otros a conocer su trabajo.",
  "The first 20 accepted providers will never be charged a provider membership fee if one is introduced, while their accounts remain in good standing. The first 10 will also be invited to an optional business spotlight. You can read the full program details before applying.": "Los primeros 20 proveedores aceptados nunca pagarán una cuota de membresía si se introduce, mientras sus cuentas estén en regla. Los primeros 10 también recibirán una invitación opcional para destacar su negocio. Puede leer todos los detalles del programa antes de solicitar.",
  "Get to know Tuveloz before we open.": "Conozca Tuveloz antes de que abramos.",
  "Start when you are ready": "Empiece cuando esté listo",
  "Create a free account and add your vehicle details when you are ready. You can take your time getting familiar with Tuveloz before bookings open.": "Cree una cuenta gratis y añada los datos de su vehículo cuando esté listo. Puede conocer Tuveloz a su propio ritmo antes de que se abran las reservas.",
  "Here's how it will work.": "Así funcionará.",
  "Once customer requests open, you'll be able to share what you need and hear from eligible local providers. For now, you can create your account and explore.": "Cuando se abran las solicitudes de clientes, podrá contar lo que necesita y recibir respuestas de proveedores locales autorizados. Por ahora, puede crear su cuenta y explorar.",
  "Know what to expect before you join.": "Sepa qué esperar antes de unirse.",
  "A few things we want you to feel comfortable with: how you choose, how your information is shared, and what a service would cost.": "Queremos que tenga claridad sobre cómo elegir, cómo se comparte su información y cuánto costaría un servicio.",
  "An unexpected car problem can leave you with plenty of questions. Tuveloz is being built so you can compare the quotes you receive and understand what is included before deciding.": "Un problema inesperado con su carro puede dejarle muchas dudas. Estamos creando Tuveloz para que pueda comparar las cotizaciones que reciba y entender qué incluyen antes de decidir.",
  "Compare the price and work described in each quote. If a provider needs more information or an in-person assessment, you can discuss that before agreeing to service.": "Compare el precio y el trabajo descrito en cada cotización. Si un proveedor necesita más información o una evaluación presencial, podrá hablarlo antes de aceptar el servicio.",
  "Options for where the work happens": "Opciones para el lugar del servicio",
  "For eligible services, a mobile provider may be able to come to you. The provider confirms whether your location is suitable before the appointment.": "Para los servicios permitidos, un proveedor móvil puede acudir a donde usted esté. El proveedor confirma si el lugar es adecuado antes de la cita.",
  "Eligible providers see the request details needed to quote. Your contact details are shared with your selected provider for the job, as described in our privacy policy.": "Los proveedores autorizados ven los datos de la solicitud necesarios para cotizar. Sus datos de contacto se comparten con el proveedor que elija para el trabajo, según nuestra política de privacidad.",
  "For customer-supplied parts, discuss the exact part and compatibility with your provider before the appointment. The quote should explain what work and costs are included.": "Si usted aporta las piezas, confirme la pieza exacta y su compatibilidad con el proveedor antes de la cita. La cotización debe explicar qué trabajo y costos incluye.",
  "Please tell us what you need. Your suggestions help us understand which services and areas to consider as Tuveloz grows.": "Cuéntenos qué necesita. Sus sugerencias nos ayudan a entender qué servicios y zonas considerar a medida que crezca Tuveloz.",
  "Example mobile provider · preview": "Proveedor móvil de ejemplo · vista previa",
  "Example local provider · preview": "Proveedor local de ejemplo · vista previa",
  "Create an account": "Crear una cuenta",
  "Create a free account": "Crear una cuenta gratis",
  "Questions about Tuveloz? Find answers about fees, parts, and provider applications in English or Spanish, or send your question to the owner.": "¿Tiene preguntas sobre Tuveloz? Encuentre respuestas sobre tarifas, piezas y solicitudes de proveedores en inglés o español, o envíe su pregunta al dueño.",
  "Compare the quotes you receive and ask questions. You can decline them all at no cost. If you book a service, review the work, fees, and total before accepting.": "Compare las cotizaciones que reciba y haga preguntas. Puede rechazarlas todas sin costo. Si reserva un servicio, revise el trabajo, las tarifas y el total antes de aceptar.",
  "Help understanding a warning light": "Ayuda para entender una luz de advertencia",
  "Ask about a code reading or eligible diagnostic service. A code reading alone does not confirm the cause or the repair.": "Consulte sobre una lectura de códigos o un servicio de diagnóstico autorizado. Una lectura de códigos por sí sola no confirma la causa ni la reparación necesaria.",

  "Your business. Your price. Your schedule.": "Su negocio. Su precio. Su horario.",
  "This is your business — run it your way. Tuveloz doesn't employ, train, or assign work to providers; you pick the jobs that fit and name your price. Sign up free — no listing fee, no subscription.": "Este es su negocio: manéjelo a su manera. Tuveloz no emplea, capacita ni asigna trabajo a los proveedores; usted elige los trabajos que le convienen y fija su precio. Solicite gratis, sin cuota por aparecer ni suscripción.",
  "Keep 100% of your quoted price — the 5% Customer Service Fee is charged to the customer on top of it": "Conserve el 100% de su precio cotizado: la Tarifa de Servicio al Cliente del 5% se cobra al cliente por encima de ese precio",
  "Work other platforms too — no exclusivity": "Trabaje también en otras plataformas: sin exclusividad",
  "Documents requested only when your exact services require them": "Solo se solicitan documentos cuando sus servicios específicos los requieren",
  "Show up. Do the work.": "Llegue. Haga el trabajo.",
  "You fix the vehicle. We knock out the paperwork.": "Usted arregla el vehículo. Nosotros nos encargamos del papeleo.",
  "Booking dates, quotes, records, invoices, getting paid — the admin that eats everyone else's evenings lives in one workspace here. Spend your time under the hood, not buried in office work.": "Fechas de citas, cotizaciones, registros, facturas y pagos: esas tareas administrativas se reúnen aquí en un solo espacio. Dedique su tiempo al vehículo, sin tanto trabajo de oficina.",
  "Customers come to you": "Los clientes llegan a usted",
  "No website to build, no ads to run. Jobs near you land in your dashboard, matched to the work you're cleared for.": "Sin tener que crear un sitio web ni administrar anuncios. Las solicitudes cercanas aparecen en su panel según los trabajos que tenga autorizados.",
  "Scheduling in one place": "Las citas en un solo lugar",
  "Confirm appointments and keep every job's date, time, and details together instead of chasing texts.": "Confirme citas y reúna la fecha, la hora y los detalles de cada trabajo sin tener que buscar entre mensajes.",
  "Quotes in minutes": "Cotizaciones en minutos",
  "Reusable quote wording and your own set prices. Send a clear scope and price fast — no phone tag.": "Reutilice el texto de sus cotizaciones y sus propios precios. Envíe el alcance del trabajo y el precio con claridad, sin llamadas de ida y vuelta.",
  "Photo-backed job records": "Registros del trabajo con fotos",
  "Snap photos of the car before, during, and after, straight from your phone. Your proof, on the record.": "Tome fotos del carro antes, durante y después del trabajo desde su teléfono. Sus pruebas quedan en el registro.",
  "Invoices and payment handled": "Facturas y pagos organizados",
  "Say yes to a price and the paperwork writes itself — authorization, invoice, receipt. Payment runs through us.": "Cuando se acepta un precio, se preparan la autorización, la factura y el recibo. El pago pasa por Tuveloz.",
  "Your numbers, private": "Sus cifras, privadas",
  "Track your own completed jobs and performance in a workspace only you can see.": "Consulte sus trabajos completados y su desempeño en un espacio privado.",
  "Get set up and poke around now — these tools go live for real jobs when we open, and we'll keep you posted. You're always your own business: we never set your prices, your hours, or how you work.": "Prepare su cuenta y explore ahora. Estas herramientas se habilitarán para trabajos reales cuando abramos; le mantendremos informado. Siempre tendrá su propio negocio: nunca fijamos sus precios, horarios ni forma de trabajar.",
  "A prohibited broad umbrella category; every job must use a specifically approved service code.": "Categoría general prohibida: cada trabajo debe usar un código de servicio aprobado específicamente.",
  "Captures customer-requested vehicle photos and customer-provided facts without diagnosis, inspection, or repair advice.": "Toma las fotos del vehículo que solicita el cliente y registra los datos que este aporta, sin diagnosticar, inspeccionar ni aconsejar reparaciones.",
  "Provides a nonofficial visual observation and factual condition report without a pass/fail or safety determination.": "Ofrece una observación visual no oficial y un informe de hechos sobre el estado del vehículo, sin aprobarlo, rechazarlo ni determinar su seguridad.",
  "Reads and reports raw OBD-II codes without clearing codes, programming, or claiming a proven repair.": "Lee y comunica los códigos OBD-II sin procesar, sin borrarlos, programar ni afirmar que una reparación está comprobada.",
  "Replaces a vehicle-specific wiper blade within the limited provisional workflow.": "Cambia una plumilla específica para el vehículo dentro del procedimiento provisional limitado.",
  "Replaces a simple engine or cabin air filter without complex trim, sensor, airbag-area, or high-voltage work.": "Cambia un filtro sencillo de aire del motor o de cabina, sin trabajos complejos en molduras, sensores, zonas de bolsas de aire ni sistemas de alto voltaje.",
  "Replaces an approved conventional vehicle bulb without advanced lighting, programming, or high-voltage work.": "Cambia un foco convencional aprobado para el vehículo, sin trabajar en iluminación avanzada, programación ni sistemas de alto voltaje.",
  "Performs only an approved, limited fluid top-off under the provisional service controls.": "Solo repone una cantidad limitada de líquido cuando está aprobado, conforme a los controles del servicio provisional.",
  "Provides a 12-volt jump start under approved roadside and stop-work controls.": "Da corriente a un sistema de 12 voltios conforme a los controles aprobados de asistencia en carretera y suspensión del trabajo.",
  "Replaces an approved 12-volt battery under provisional roadside, competency, and spent-battery controls.": "Cambia una batería de 12 voltios aprobada conforme a los controles provisionales de asistencia en carretera, competencia y manejo de baterías usadas.",
  "Installs a vehicle-compatible temporary spare under limited roadside and safety controls.": "Instala una llanta de repuesto temporal compatible con el vehículo conforme a controles limitados de asistencia en carretera y seguridad.",
  "Performs approved basic detailing under the required wash-water and environmental controls.": "Realiza detallado básico aprobado conforme a los controles exigidos para las aguas de lavado y el medio ambiente.",
  "Performs an approved oil-and-filter service only through the sponsored trainee pathway with direct supervision.": "Realiza un cambio de aceite y filtro aprobado solo mediante la vía de aprendiz patrocinado, con supervisión directa.",
  "Replaces a standard vehicle battery with required registration, insurance, and spent-battery handling evidence.": "Cambia una batería convencional del vehículo con los registros, seguros y pruebas exigidos para el manejo de baterías usadas.",
  "Performs approved tire repair or installation under the standard-provider workflow.": "Realiza reparación o instalación de llantas aprobada conforme al procedimiento de proveedor estándar.",
  "Performs limited non-SRS, non-ADAS, non-high-voltage diagnostics without an official inspection representation.": "Realiza diagnósticos limitados que excluyen SRS, ADAS y alto voltaje, sin presentarlos como una inspección oficial.",
  "Performs an approved vehicle-wash process with required wash-water capture and disposal controls.": "Realiza un lavado de vehículo aprobado con los controles exigidos para captar y desechar el agua de lavado.",
  "Performs approved refrigerant service under the EPA Section 609 and specialty-service workflow.": "Realiza servicios de refrigerante aprobados conforme a la Sección 609 de la EPA y al procedimiento de servicios especializados.",
  "Performs body and paint refinishing only at an approved permitted facility.": "Realiza trabajos de carrocería y repintado solo en una instalación aprobada que cuente con los permisos correspondientes.",
  "Installs window tint only under approved legal-compliance and meter controls.": "Instala polarizado de ventanas solo conforme a los controles aprobados de cumplimiento legal y medición.",
  "Provides approved towing or storage with the required registrations and custody coverage.": "Presta servicios aprobados de remolque o almacenamiento con los registros y la cobertura de custodia exigidos.",
  "Provides lockout assistance only through the approved licensed-locksmith identity and location workflow.": "Ayuda a abrir vehículos cerrados solo mediante el procedimiento aprobado de verificación de identidad y ubicación de un cerrajero con licencia.",
  "Performs an official inspection only at a licensed fixed station with a licensed inspection mechanic.": "Realiza una inspección oficial solo en una estación fija autorizada y con un mecánico inspector con licencia.",
  "Provides approved emergency fuel delivery under the required fuel, hazmat, spill, environmental, and fire controls.": "Entrega combustible de emergencia cuando está aprobado, conforme a los controles exigidos de combustible, materiales peligrosos, derrames, medio ambiente e incendios.",
  "Reserved for a future nonempty EV high-voltage scope that satisfies mandatory legal, agency, insurance, training, PPE, tool, facility, and emergency requirements.": "Reservado para un futuro alcance definido de servicios de alto voltaje para vehículos eléctricos que cumpla los requisitos obligatorios legales, de agencias, seguros, capacitación, protección personal, herramientas, instalaciones y emergencias.",
  ...
  "Tuveloz Help": "Ayuda de Tuveloz",
  "Tuveloz Help | Tuveloz": "Ayuda de Tuveloz | Tuveloz",
  "Ask a question": "Hacer una pregunta",
  "Finding an answer…": "Buscando una respuesta…",
  "Tuveloz guide": "Guía de Tuveloz",
  "Ask about fees, parts, or choosing a provider.": "Pregunte sobre tarifas, piezas o cómo elegir un proveedor.",
  "Ask about applying, required documents, or getting paid.": "Pregunte cómo solicitar, qué documentos necesita o cómo recibirá sus pagos.",
  ...
  "Your Tuveloz account": "Su cuenta de Tuveloz",
  ...
  "Create an account, sign in, or continue your provider application. Customer bookings are not open yet.": "Cree una cuenta, inicie sesión o continúe su solicitud de proveedor. Las reservas para clientes aún no están abiertas.",
  ...
  "Provider applications are open in Montgomery County, Maryland. If you're elsewhere in Maryland or Washington, DC, tell us your area. Your requests help us decide where to open next.": "Estamos aceptando solicitudes de proveedores en el Condado de Montgomery, Maryland. Si está en otra parte de Maryland o en Washington, DC, díganos su área. Sus solicitudes nos ayudan a decidir dónde abrir después.",
  "Customers": "Clientes",
  "Providers": "Proveedores",
  "Mobile mechanics & service trucks": "Mecánicos móviles y camiones de servicio",
  "Request your area": "Solicite su área",
  "Tell us where you'd like to use Tuveloz.": "Cuéntenos dónde le gustaría usar Tuveloz.",
  ...
  "Keep your sign-in code private. Each code works once and expires after 10 minutes.": "Mantenga privado su código de acceso. Cada código funciona una sola vez y vence después de 10 minutos.",
  "Customer and provider accounts do not give access to owner or admin tools.": "Las cuentas de clientes y proveedores no dan acceso a las herramientas de dueños o administradores.",
  ...
  "Review each provider's details before booking": "Revise los datos de cada proveedor antes de reservar",
  ...
  "Have another service in mind?": "¿Tiene otro servicio en mente?",
  ...
  "Choose your provider": "Elija a su proveedor",
  ...
  "Requests reach eligible local providers": "Las solicitudes llegan a proveedores locales autorizados",
  "After launch, your request will reach local providers approved for that service. Each provider decides whether to send a quote.": "Tras el lanzamiento, su solicitud llegará a proveedores locales autorizados para ese servicio. Cada proveedor decide si enviar una cotización.",
  ...
  "Want launch updates by email?": "¿Quiere recibir novedades del lanzamiento por correo?",
  "Get occasional emails as we prepare to open in Montgomery County. No account needed, and you can unsubscribe at any time.": "Reciba correos ocasionales mientras preparamos el lanzamiento en el Condado de Montgomery. No necesita una cuenta y puede cancelar la suscripción cuando quiera.",
  ...
  "No. You can compare quotes, ask questions, and decline every quote at no cost.": "No. Puede comparar cotizaciones, hacer preguntas y rechazar todas las cotizaciones sin costo.",
  "Who actually does the work?": "¿Quién hace el trabajo en realidad?",
  "The independent service provider you choose performs the work on your vehicle. Tuveloz connects you online and keeps the agreed work and price in one place.": "El proveedor independiente que usted elija realiza el trabajo en su vehículo. Tuveloz los conecta por internet y reúne el trabajo y el precio acordados en un solo lugar.",
  ...
  "When we open, you can choose a provider or decline every quote": "Cuando abramos, podrá elegir un proveedor o rechazar todas las cotizaciones",
  ...
  "At launch: request service, compare quotes, and choose a provider.": "En el lanzamiento: solicite un servicio, compare cotizaciones y elija un proveedor.",
