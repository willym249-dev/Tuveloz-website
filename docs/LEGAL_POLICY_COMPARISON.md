...
> **DECIDED (August 6, 2026): Option B, made optional, with tiered periods.**
> Providers may choose to offer the Tuveloz standard labor warranty, a different
> written warranty, or none. The standard labor warranty is honored by
> re-performing the covered labor at no additional labor charge, with a period
> tiered by work type: 12 months / 12,000 miles for repair and replacement work;
> 90 days / 3,000 miles for maintenance and consumables (oil changes, filters,
> wipers, bulbs); 7 days for cosmetic work (detailing); no workmanship warranty
