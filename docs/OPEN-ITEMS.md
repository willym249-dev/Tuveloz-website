...
| 2026-09-07 | Send the free Maryland paperwork pack (`brand/repair-paperwork-pack/`) as the opener on the next five outreach DMs, instead of leading with the application. This is the $0 test of whether the wedge in `business/revenue-before-launch.md` converts at all | hello@tuveloz.com | open |
| 2026-09-07 | Put the Google Business Profile live. Free, highest-intent channel, still not live per `brand/outreach/audience-growth-playbook.md`; roughly an hour, and everything else in the revenue plan is harder without it | hello@tuveloz.com | open |
| 2026-09-14 | Set the price for the personalized paperwork pack and create the Stripe Payment Link for it. $49 is a starting number, not a researched one. First-party sale of our own document — no Connect, no marketplace object, no lock involved | hello@tuveloz.com | open |
| 2026-09-30 | Ask the insurance broker, in the same conversation that answers `platform_and_service_insurance_bound`, whether they pay a referral fee for commercial auto and GL placed with independent mechanics — and what Maryland requires of an unlicensed referrer. Optional, disclosed, never a condition of approval, or it does not happen | hello@tuveloz.com | open |
| 2026-09-30 | Ask the CPA how Maryland treats a one-off digital product and a later software subscription for sales tax. Overlaps the `cpa_tax_mor_and_transaction_map` gate, so ask once and record the answer against both | hello@tuveloz.com | open |
| 2026-10-15 | Decide whether to build the subscription version of the paperwork tool, on the evidence from the free pack. If the pack started no conversations, the answer is no and that is worth knowing before a build | hello@tuveloz.com | open |
| 2026-10-15 | Get a reviewed Spanish courtesy translation of the paperwork pack. The statutory notices stay in English; the surrounding form does not have to, and this repository does not ship unreviewed Spanish | hello@tuveloz.com | open |
