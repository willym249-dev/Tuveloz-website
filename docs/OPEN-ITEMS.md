...
| --- | --- | --- | --- |
| 2026-09-30 | Finish private production backup activation and isolated restore. September 26: PRs #229/#230 merged, private bucket and unscheduled Worker deployed, D1 Read secret saved. First export returned HTTP 401; retries stopped. Separate owner approval is pending before trying broader D1 Edit. No backup or restore is proved, and the nightly schedule is off. Internal review target, not an external deadline | hello@tuveloz.com | blocked |
