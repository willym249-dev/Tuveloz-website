...
| --- | --- | --- | --- |
| 2026-09-30 | Finish nightly backup activation and observe the first automatic run. September 26: owner-approved D1 Edit succeeded; database and both objects backed up and recovered into separate local SQLite/files with integrity and hash checks passing. Native Workflow scheduling required Paid; standard free Worker Cron replacement is prepared. No paid upgrade. Internal review target, not an external deadline | hello@tuveloz.com | open |
| 2026-10-02 | Rehearse recovery into separate Cloudflare D1/R2 destinations and verify application behavior with integrations disabled. September 26 proved local SQLite/file recovery only; no cloud restore or production cutover has been performed. Internal review target | hello@tuveloz.com | open |
