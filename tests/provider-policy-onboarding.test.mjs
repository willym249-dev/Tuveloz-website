...
test("draft policy acknowledgments are bound for review but fail closed for job eligibility", async () => {
  ...
  assert.ok(Object.entries(releaseManifest).every(([key, release]) => (
    ["terms", "provider_agreement", "customer_agreement", "payment_policy", "provisional_provider_policy", "marketplace_conduct", "privacy", "vehicle_service_risk", "provider_safety_policy"].includes(key)
