...
/* ---------------------------------------------------------------------------
 * Guards carried over from the 5% fee lock (#124) on main. These cover the
 * rate itself and the two copy regressions that have already happened once:
 * the legacy 10% customer fee, and expressing the fee as a deduction that
 * leaves providers with 95%. The tests above cover the fee NAME; these cover
 * the fee MODEL. Both sets must pass.
 * ------------------------------------------------------------------------ */
